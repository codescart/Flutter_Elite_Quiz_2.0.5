                    ...
                    children: [
                      ...
                      _getTimeInMinutesAndSeconds().isNotEmpty
                          ? Text(
                              ...
                              style: TextStyle(fontSize: widget.textFontSize != null ? (widget.textFontSize! - 5) : 12, color: Theme.of(context).backgroundColor.withOpacity(0.8), fontWeight: FontWeight.w500),
                            )
                          : Container(),
                    ],
                  ),
